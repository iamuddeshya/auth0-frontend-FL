...
//a function which gets data from localstorage.
    getUserdata () {
      let userObj = JSON.parse( localStorage.getItem( 'user' ) ); //parses the stringified user data stored in local storage to JSON
        console.log( "The user nickname is  " + userObj.nickname );
    },
